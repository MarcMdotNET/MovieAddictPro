...
namespace MovieAddictPro.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        {
            var defaultCollectionName = _appSettings.MovieAddictProSettings.DefaultCollection.Name;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Collection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (collection.Name == _appSettings.MovieAddictProSettings.DefaultCollection.Name)
                    {
