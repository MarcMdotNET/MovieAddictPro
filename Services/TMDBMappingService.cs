...
namespace MovieAddictPro.Services
{
    public class TMDBMappingService : IDataMappingService
    {
        ...
        {
            if (string.IsNullOrEmpty(profilePath)) return _appSettings.MovieAddictProSettings.DefaultCastImage;
            return $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.MovieAddictProSettings.DefaultPosterSize}/{profilePath}";
        }
        ...
        {
            var posterPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.MovieAddictProSettings.DefaultPosterSize}/{path}";
        ...
        {
            var backdropPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.MovieAddictProSettings.DefaultBackdropSize}/{path}";
